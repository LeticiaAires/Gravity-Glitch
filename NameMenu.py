...
class NameMenu(MenuManager):
    def __init__(self): 
        ...
        self.title_play_text = self.title_play_font.render("Name Menu", True, (255, 255, 255))
        self.title_play_rect = self.title_play_text.get_rect(center=(self.SCREEN_WIDTH // 2, 50))

        self.title2_play_font = pygame.font.Font(self.font_path, 25)
        ...
        self.continue_rect = pygame.Rect((self.SCREEN_WIDTH - self.BUTTON_WIDTH) - 100, 500, self.BUTTON_WIDTH, self.BUTTON_HEIGHT)
    ...
    def run(self):
        ...
        while running:
            ...
            self.screen.blit(self.title2_play_text, (self.SCREEN_WIDTH // 3 - 250, 110))
